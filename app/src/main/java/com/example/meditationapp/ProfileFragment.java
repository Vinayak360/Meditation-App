...
public class ProfileFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        progress_txt.setText("Your M-Score is : " + progress);
        ...
        achievement_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (progress < 5) {
                    Toast.makeText(getContext(), "Your M-score should be 5", Toast.LENGTH_SHORT).show();
                } else {
        ...
        achievement_3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (progress < 100) {
                    Toast.makeText(getContext(), "Your M-score should be 100", Toast.LENGTH_SHORT).show();
                } else {
                    Intent intent = new Intent(getContext(), AchievementActivity.class);
